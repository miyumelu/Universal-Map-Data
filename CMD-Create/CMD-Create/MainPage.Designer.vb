...
Partial Class MainPage
    ...
    Private Sub InitializeComponent()
        ...
        Minimize_Button.Font = New Font("Segoe UI", 12F)
        ...
        Form_Label.Text = "Universal Map Data Creator"
        ...
        btnSrc.Font = New Font("Segoe UI", 12F)
        ...
        btnPack.Font = New Font("Segoe UI", 12F)
        ...
        ' btnMigrateCmdToUmd
        ' 
        btnMigrateCmdToUmd.BackColor = Color.FromArgb(CByte(60), CByte(62), CByte(80))
        btnMigrateCmdToUmd.FlatStyle = FlatStyle.Flat
        btnMigrateCmdToUmd.Font = New Font("Segoe UI", 12F)
        btnMigrateCmdToUmd.ForeColor = Color.White
        btnMigrateCmdToUmd.Location = New Point(20, 325)
        btnMigrateCmdToUmd.Name = "btnMigrateCmdToUmd"
        btnMigrateCmdToUmd.Size = New Size(500, 40)
        btnMigrateCmdToUmd.TabIndex = 11
        btnMigrateCmdToUmd.Text = "Migrate CMD to UMD"
        btnMigrateCmdToUmd.UseVisualStyleBackColor = False
        ' 
        ' MainPage
        ' 
        ...
        Controls.Add(btnMigrateCmdToUmd)
    ...
    Friend WithEvents btnMigrateCmdToUmd As Button
End Class
